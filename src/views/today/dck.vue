  ...
  <div class="spp-theme-body spp-theme-pad">
    ...
    <el-form :inline="true" size="small" :model="tableSearchParams" class="spp-form-search spp-theme-top">
      ...
      <el-form-item>
        ...
        <el-button size="small" type="warning" plain @click="onExport()">导出</el-button>
      </el-form-item>
    </el-form>
  ...
  methods: {
    ...
    onExport() {
      ...
      require.ensure([], () => {
        ...
        var tHeader = ['单据编号', '业务单据', '单据日期', '业务员']
        var filterVal = ['number', 'document', 'updateDate', 'name']
